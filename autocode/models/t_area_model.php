 ...
 */
class T_area_model extends MY_Model
{
	/**
	 * @COLUMN_KEY		PRI
	 * @DATA_TYPE		int
	...
	*/
	...
	{
		return $this->db->get_where('t_area',array('id' => $id))->row();
	}
	...
	{
		return $this->db->count_all('t_area');
	}
	...
	*/
	...
	{
		return $this->db->delete('t_area',array('id' => $id));
	}
