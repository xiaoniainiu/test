 ...
 */
class T_province_model extends MY_Model
{
	/**
	 * @COLUMN_KEY		PRI
	 * @DATA_TYPE		int
	...
	*/
	...
	{
		return $this->db->get_where('t_province',array('id' => $id))->row();
	}
	...
	{
		return $this->db->count_all('t_province');
	}
	...
	*/
	...
	{
		return $this->db->delete('t_province',array('id' => $id));
	}
